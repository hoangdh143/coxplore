...
import com.coxplore.helper.ResponseBody;
import com.coxplore.helper.SuccessHttpResponse;
import com.coxplore.model.Group;
import com.coxplore.repository.AuthenticationTokenRepository;
import com.coxplore.repository.GroupRepository;
import com.coxplore.repository.UserRepository;
import com.coxplore.security.GenerateJWT;
...
public class FacebookService {
    ...
    public HttpResponse registerAndLogin(String accessToken, String introduceCode, HttpServletRequest req, HttpServletResponse res) throws Exception {
        try {
            ...
            com.coxplore.model.User userExist = userRepository.findByEmail(facebookUser.getEmail());
    ...
    private HttpResponse getResponseOfExistingUserAccount(com.coxplore.model.User user, HttpServletRequest req, HttpServletResponse res) {
    ...
    private HttpResponse registerAndActivateNewUserAccount(User facebookUser, com.coxplore.model.User userExist, String introduceCode, HttpServletRequest req, HttpServletResponse res) throws Exception {
        com.coxplore.model.User user;

        if (userExist != null) {
            user = userExist;
        } else {
            user = new com.coxplore.model.User();
        }
        ...
        com.coxplore.model.User userDb = userRepository.save(user);
